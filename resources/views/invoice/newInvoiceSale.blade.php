    ...
    <section class="content-header">
      <h1>
        ...
        <div class="pull-right">
            ...
            <a href="{{url('/new-sales-form')}}" class="btn btn-danger"> Back</a>
        </div>
    ...
    <section  id="invoiceToPrint" class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> ABC Purse.
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>ABC Purse.</strong><br>
            Shalmi<br>
            Main Road<br>
            Phone: 0423-1234567<br>
            Email: abcPurse@purse.com
          </address>
        </div>
        <!-- /.col -->
        {{-- <div class="col-sm-4 invoice-col">
        ...
        <div class="col-xs-6">
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tr>
                <th>Amount Paid:</th>
                <td>Rs. {{$sale->amountPaid}}</td>
              </tr>
              <tr>
                <th>Balance:</th>
                <td>Rs. {{$sale->amountRemaining}}</td>
              </tr>
              <tr>
                <th>Return:</th>
                <td>Rs. {{$sale->returnAmount}}</td>
              </tr>
