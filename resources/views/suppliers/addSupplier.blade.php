...
<div class="box box-info">
    <div class="box-header with-border">
        <h1 class="box-title">Add New Supplier</h1>
        <div class="pull-right">
            <a href="{{ url('show-suppliers') }}" type="button" class="btn btn-danger">Back</a>
        </div>
    </div>

    <form class="form-horizontal" method="post" action="{{url('add-suppliers')}}">
        @csrf()
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="supplierAddress" name="supplierAddress" placeholder="" >
                </div>
            </div>
