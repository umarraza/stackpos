...
<div class="box box-info">
    ...
    <form class="form-horizontal" method="post" action="{{url('supplier-update')}}">
        @csrf()
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="supplierName" name="supplierName" placeholder="Ali" required="true" value="{{$supplier->name}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="tel" class="form-control" id="mobNumber" name="mobNumber" placeholder="000-0000000" required="true" value="{{$supplier->cellNumber}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="supplierAddress" name="supplierAddress" placeholder="" required="true" value="{{$supplier->address}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="accountNumber" name="accountNumber" placeholder="" required="true" value="{{$supplier->accountNumber}}">
                </div>
            </div>
            <input type="hidden" class="form-control" id="id" name="id" required="true" value="{{$supplier->id}}">
{{--             <div class="form-group">
